...
metabolomicsData <- read_excel(paste0(getwd(),"/Data/Meta_data.xlsx"), sheet = "nmr_intervention")
...
```{r}
### To be added by you!
heatmaply::heatmaply(metabolomicsDataGroups[,103:229], grid_gap = 1, colors = heat.colors(200), showticklabels = c(T, F), margins = c(80, 10))
